...
async function main() {
  ...
  const record = allRecords.find(r =>
    r.fields["Name"] && r.fields["Name"].toLowerCase().includes("oikos")
  );

  if (!record) { console.error("Could not find OIKOS Property Developments!"); process.exit(1); }
...
<head>
  ...
  <title>OIKOS Property Developments — Office Locations</title>
